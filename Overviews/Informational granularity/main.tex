\documentclass[10pt, onecolumn, nofootinbib]{revtex4-1}
...
\begin{document}
	...
	%TODO: add e-mail
	%TODO: not have page break on first page
...
The fact that the $\sigma$-algebra is generated by a countable set means it is separable. It also means that each element can be constructed as a disjunction of a set of possibilities. For the full definitions, see \cite{AoPBook}.
...
It would be nice to be able to prove the following either true or false.

\begin{conj}\label{uniformconsequence}
