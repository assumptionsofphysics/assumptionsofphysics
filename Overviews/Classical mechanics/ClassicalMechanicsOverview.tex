...
The overall argument (see \cite{AoPPhy1,aop-book} for more details) can be summed up in the following diagram that can be used as a guide throughout this note.
