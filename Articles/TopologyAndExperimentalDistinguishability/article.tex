...
\begin{proof}
	We need to show that the basis-to-basis topology is a topology. By definition, it is closed under finite intersection and arbitrary union. The set $V(X,\emptyset)$ is in the topology and contains no functions.  The set $V(X,Y)$ is in the topology and contains all functions.
\end{proof}
