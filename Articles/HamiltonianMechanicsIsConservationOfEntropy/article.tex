...
\begin{align*}
\frac{\hbar}{2} &= \frac{h}{4\pi} \equiv \frac{e^{I_0 - 1}}{2 \pi} =  \frac{e^{I_0}}{2 e \pi} \leq \sigma_q\sigma_p
\end{align*}
...
%These results represent one set of insights from our larger project, Assumptions of Physics, that aims to rederive the standard laws from a handful of physical starting points.
