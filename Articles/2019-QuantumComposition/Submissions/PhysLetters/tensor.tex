...
$I$ such that $I \circ T=m$. Since we show that $I$ is
an isomorphism, then $I$ bijectively maps vectors in $\cal C$
onto vectors in the tensor product space. Namely $m={T}=\otimes$. (XXX)
