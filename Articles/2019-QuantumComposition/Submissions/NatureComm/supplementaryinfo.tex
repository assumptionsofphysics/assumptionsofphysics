...
\begin{document}
	...
	\begin{remark}
		...
		the space. The exception is proposition \ref{prop_fundProj} for which the prove the finite case by induction and then show that it holds in the limit. This would not work in the non-separable case, since the basis would not be countable.
	\end{remark}
