...
\end{condition}
\begin{Theorem}
	Over \ref{QST:H}+\ref{1DOF}, the conditions \ref{CL-HBAR}, \ref{CL-HENT} and \ref{CL-CST} are equivalent.
\end{Theorem}
...
\begin{Theorem}
	Condition \ref{QST:H} implies \ref{EE-DIN}, \ref{EE-MEAS} and \ref{EE-THER}.
\end{Theorem}
