...
@Book{Gelfand,
  ...
  Note      = {revised english edition; Silverman edited it as well and added problems},
}
...
% % Removed: Similarly, an axiomatization that includes more axioms is less fundamental than one which drops these axioms while maintaining the same expressive power.
%Worry: what if  both axiom systems cover the same class of systems? then seemingly no difference in generality? 
...
% Could cite Woodward, or Cohen/Callender for skepticism about perfectly natural properties. Includes naturalistically-minded philosophers
...
%The use of manifolds is, technically, a choice of how the physics is represented
...
%Moreover, the units we choose for $\omega$ are the units we choose to count states over an independent degree of freedom. This agrees with the practice in statistical mechanics. 
