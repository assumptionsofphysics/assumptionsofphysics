...
%% To compile bibliography, run Bibtex, which will generate a file `references.bib' which is called in the References section. 
%The file calls one diagram, labeled `Diagram.png' 
...
\iffalse
\titleformat{\subsubsection}[runin]% for acknowledgements 
{\normalsize\bfseries}%
...
\fancyhead[OL]{\small{Hamiltonian Privilege}}
\fancyhead[ER]{\small{Hunt, Carcassi, and Aidala}}%Even page header 
\fancyfoot[L,R,C]{}
...
\hypersetup{
	...
	pdfauthor={Hunt, Carcassi, and Aidala},
	pdfsubject={},
	pdfkeywords={},
	pdfcreator={XeLaTeX},
	pdfproducer={XeLaTeX},
...
\date{\vspace{-7.9ex} Josh Hunt, Gabriele Carcassi, and Christine Aidala \\ \today}
\maketitle
%
\vspace{-8mm}
...
This paper forms part of the ongoing \textit{Assumptions of Physics} project \parencites[]{aop-book}. This project aims to both (i) isolate the physical assumptions required for different frameworks in mathematical physics and (ii) consider their philosophical implications. The authors would like to thank Gordon Belot for comments, along with two reviewers for this journal and four reviewers at two other journals, all of whom provided extremely helpful and constructive comments. 
