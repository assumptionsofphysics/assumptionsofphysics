...
TODO: remove all the - in quasi-probability
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{The integrand $\frcap_{\ens[o]}(A(s))$ as a function of $s$.}
\end{figure}
...
We have seen that classical probability arises exactly when we are describing a set of ensembles that can always be decomposed in a unique set of mutually distinguishable cases. In quantum mechanics, instead, pure states
