...
\begin{figure}[H]
	...
	\begin{tikzpicture}[x={(\xx cm, \xy cm)}, y={(\yx cm, \yy cm)}, z={(\zx cm, \zy cm)}, scale=1.2]
		...
		\end{scope}
	\end{tikzpicture}
	\caption{Examples of a classical (triangle) and quantum (ball) ensemble space in three and two dimensions, respectively.}
\end{figure}
...
%		\end{scope}
		...
		\end{scope}
	\end{tikzpicture}
	\caption{Geometrical representation of the element $\ens[e]$ in $A(s)$ with the largest fraction of $\ens[o]$.}
\end{figure}
