...
\begin{figure}[H]
	...
	\begin{tikzpicture}[x={(\xx cm, \xy cm)}, y={(\yx cm, \yy cm)}, z={(\zx cm, \zy cm)}, scale=1.2]
		...
		\begin{scope}[canvas is zx plane at y=\radius-\s]
			\draw (-0.9*\margin, -1.1*\margin) node[below left, circle, draw, thick, color=colora] {1};
		...
		\begin{scope}[canvas is zx plane at y=-\s]
			\draw (-0.9*\margin, -1.1*\margin) node[below left, circle, draw, thick, color=colorb] {2};
		...
		% cut 3
		\begin{scope}[canvas is zx plane at y=\s]
			\draw (-0.9*\margin, -1.1*\margin) node[below left, circle, draw, thick, color=colorc] {3};
