...
To make this determination, we need to provide a standard to judge the physicality of a formal definition.\cite{redei_tension_2020, north_physics_2021} Suppose we are studying a physical system. A mathematical definition is \textbf{physical} if it properly characterizes the physical system in the given conditions. That is, if we are able to \textbf{justify on physical grounds} that the given mathematical definition is needed to capture and only capture a particular aspect of the physical system under the given condition. On the other hand, a mathematical definition is \textbf{unphysical} if it can be shown to require properties or operations that cannot have a physical counterpart. The question of this paper, then, is whether the use of Hilbert spaces to characterize quantum systems can be justified on physical grounds, from physical requirements. This is the task at hand.

Some mathematicians were disappointed that we didn't discuss in depth approaches like rigged Hilbert spaces or the algebraic approach to quantum mechanics. Do rigged Hilbert spaces spell out exactly what each element of the Gelfand triple describes and give a physical justification that tells us exactly which of those are the physically correct specifications? Do algebraic approaches give a physical justification as to why things we measure in a lab must be modeled by a $C^*$-algebra, and consequently allow us to determine whether the use of Hilbert spaces to model states can be given (or not given) a physical justification? To our knowledge, and to the knowledge of the mathematicians that approached us, they do not. This does not mean that these works are of no interest to a physical audience. It just means they are not going to help with the task at hand.
