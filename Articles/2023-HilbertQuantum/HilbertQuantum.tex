...
\end{equation}
If we define $p(\psi, \phi) = |\langle\psi|\phi\rangle|$ and $I(\psi, \phi) = H( \frac{1}{2}|\psi\>\<\psi| + \frac{1}{2}|\phi\>\<\phi|)$ we have %TODO: Define f. It looks like a von Neumann entropy, but we haven't used the notation f(p) before.
