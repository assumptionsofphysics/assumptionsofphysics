...
\end{equation}
%nn capisco come mai in (1) l'entropia � data soltanto da $\rho_1$.
...
%la questione dei contesti non � discussa prima in maniera esplicita e secondo me pu� non essere compresa appieno. Aggiungerei una frase a proposito, che ne dite?
...
%pensate che quest'ultimo punto non possa essere approfondito in un paragrafo ulteriore? (da rimanere entro la pagina intendo, giusto un paio di frasi per dare un'idea del perch� il problema non sia la modalit� con cui uno calcola l'entropia)
...
As $\rho$ is in a diagonal form, the entropy is given by eq.~\ref{entropy}.\end{document}