...
Therefore there are two different ways ontological models use classical measure theory: one in mixtures, highlighted by us; one in composite systems, highlighted by PBR. The use of measure theory is what drives the failure of the model.
