...
\textcolor{magenta}{Therefore, not only their categorization is shown to be empty, but also it does not offer a rigorous philosophical ground where to cast the interpretational debate.}
