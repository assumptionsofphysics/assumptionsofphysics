\documentclass[twocolumn,prl,floatfix,superscriptaddress]{revtex4-1}
...
Andrea Oldofredi is grateful to the Funda\c{c}$\tilde{\mathrm{a}}$o para a Ci\^encia e a Tecnologia (FCT) for financial support (Grant no. 2020.02858).
