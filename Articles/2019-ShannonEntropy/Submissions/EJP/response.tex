...
This referee report, while abundant in ad hominem, mischaracterizations and demeaning language, was outstandingly lacking in constructive criticism. This is peer reviewing at its worst. The most likely scenario is that, after a very cursory look, he framed the manuscript in terms of some dispute the referee has with some other colleagues, stopped reading carefully and engaged in a tirade, assigning to us views that are not our own. This means that most of the comments weren't even directly relevant to our manuscript: even after sifting the report carefully, we found no major actionable items.
