...
\begin{aligned}
\hat{q} &= \hat{q}(q) \\
|J| = \{\hat{q}, \hat{p}\} &= 1 = \frac{\partial \hat{q}}{\partial q} \frac{\partial \hat{p}}{\partial p} \\
...
Under a change of variables, the two-form $\omega$ must be invariant. That is, the particle state space $(\mathcal{S}, \omega)$ is a symplectic manifold. And, as any symplectic manifold, we can find Darboux variables $\xi^a = \{q^i, p_j\}$ and express the two-form as
\begin{equation}
\label{Symplectic}
\begin{aligned}
